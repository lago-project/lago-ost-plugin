# -*- coding: utf-8 -*-
#
# lago-ost-plugin documentation build configuration file, created by
...
project = u'lago-ost-plugin'
copyright = u'2017, Lago team'
author = u'Lago team'
...
#
# html_title = u'lago-ost-plugin v0.38'
...
htmlhelp_basename = 'lago-ost-plugindoc'
...
latex_documents = [
    (
        master_doc, 'lago-ost-plugin.tex', u'lago-ost-plugin Documentation',
        u'Lago team', 'manual'
    ),
]
...
man_pages = [
    (
        master_doc, 'lago-ost-plugin', u'lago-ost-plugin Documentation',
        [author], 1
    )
]
...
texinfo_documents = [
    (
        master_doc, 'lago-ost-plugin', u'lago-ost-plugin Documentation',
        author, 'lago-ost-plugin', 'One line description of project.',
        'Miscellaneous'
    ),
]
